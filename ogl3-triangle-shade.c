...
void init_geometryTriangle(GLuint program)
{
	...
	GLfloat normalData[] = {0, 0, 1,
	                        0, 0, 1,
	                        0, 0, 1};
	triangle.attrib_normal = normalData;
	triangle.attrib_normal_components = 3; // each normal has X, Y, Z
	triangle.attrib_normal_name = "in_Normal";
...
void init_geometryQuad(GLuint program)
{
	...
	GLfloat normalData[] = {0, 0, 1,
	                        ...
	                        0, 0, 1,
	                        0, 0, 1};
	quad.attrib_normal = normalData;
	quad.attrib_normal_components = 3; // each normal has X, Y, Z
	quad.attrib_normal_name = "in_Normal";
